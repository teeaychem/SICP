...
#+BEGIN_SRC racket
  (controller
   ...
   (branch (label fact-done))
   (assign s (op +) (reg counter) (constant 1))
   (assign t (op *) (reg counter) (constant product))
...
#+BEGIN_SRC racket
  (controller
   ...
   (test (op >) (reg counter) (reg n))
   (branch (label fact-done))
   (assign s (op *) (reg counter) (constant product))
...
#+BEGIN_SRC racket
  (controller
   ...
   (assign guess (reg x))
   test-guess
   (assign guess (op *) (reg guess) (reg guess))
   (assign guess (op -) (reg guess) (reg x))
   (assign guess (op abs) (reg guess))
   (assign guess (reg guess-a))
   (test (op <) (reg guess) (const 0.001))
   (branch (label sqrt-done))
