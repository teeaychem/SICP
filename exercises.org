...
This is cool!
I guess testing for cycles isn't so hard if we keep a list of pointers accessed, though this probably expensive to check.
So, something more careful is involved.
...
Interesting!
I guess something is done when ~set-cdr!~ is evaluated.
