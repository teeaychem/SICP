...
We'd need to update the operators used within deriv, as now +, *, etc. all require disambiguation.
Something like number should work for this, as +, *, etc. as used are only defined with respect to numbers.
I guess this includes rationals, and possibly more?
