...
#+BEGIN_SRC racket
  (define (inside-circle? r ox oy)
    ...
    (define (estimate-pi-circle size trials)
      <<def:estimate-integral>>
      <<def:square>>
      (let ((center+Radius (/ size 2)))
	(* 4.0 (/ (estimate-integral (inside-circle? center+Radius center+Radius center+Radius) 0 size 0 size trials) (square size)))))

  (estimate-pi-circle 9999 999)
#+END_SRC
