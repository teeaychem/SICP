...
#+BEGIN_SRC racket
  (define (invert-series s)
    ...
    (let ((carS (car s))
	  (scale (/ 1 (car s))))
      (scale-stream (invert-unit-series (scale-stream s scale)) carS)))
  ...
  (eat (div-series sine-series cosine-series) 100)
...
Alright, these exercises were interesting, but the majority of the work was figuring out series (again).
